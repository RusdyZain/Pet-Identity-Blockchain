...
exports.createCorrectionController =
  exports.acceptTransferController =
  exports.initiateTransferController =
  exports.ownershipHistoryController =
  exports.getPetController =
  exports.listPetsController =
  exports.createPetController =
    void 0;
  ...
  try {
    ...
    const search =
      typeof req.query.search === "string" && req.query.search.length > 0
        ? req.query.search
        : undefined;
    const pets = await (0, petService_1.listPets)(
      req.user,
...
const ownershipHistoryController = async (req, res, next) => {
  try {
    ...
    const history = await (0, petService_1.getOwnershipHistory)(
      petId,
      req.user
    );
    res.json(history);
...
const initiateTransferController = async (req, res, next) => {
  try {
    ...
    const result = await (0, petService_1.initiateTransfer)(
      petId,
      req.user.id,
      new_owner_email
    );
