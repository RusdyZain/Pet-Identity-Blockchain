...
exports.markNotificationReadController = exports.listNotificationsController = void 0;
...
const markNotificationReadController = async (req, res, next) => {
    try {
        ...
        const notification = await (0, notificationService_1.markNotificationAsRead)(notificationId, req.user.id);
